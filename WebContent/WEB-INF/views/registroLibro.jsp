...
<%
	List<Autor> autorLista = (List<Autor>) request.getAttribute("autorLista");
%>
...
<body>
	<div class="container-fluid">
			...
			<div class="header-container">
				...
				<div class="register text-center">
					<a href="${pageContext.request.contextPath}/registroLibro">Registro
						Libro</a> | <a href="${pageContext.request.contextPath}/registroRevista">Registro
						Revista</a> | <a
		...
		<section class="home-view">
			...
			<form method="POST" action="doRegistroLibro">
				<table>
					<tr>
						<td>Nombre</td>
						<td>
