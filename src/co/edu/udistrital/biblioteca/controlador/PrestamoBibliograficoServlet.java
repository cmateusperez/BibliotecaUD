...
public class PrestamoBibliograficoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<MaterialBibliografico> materialBibliograficoList = iBibliotecaServicios
				.prestarMaterialBibliografico("1", new Integer(codigo));
		request.setAttribute("materialBibliografico", materialBibliograficoList);
